...
result=s:1
parametric=s:P
treepath=s:1D Results\Power\Excitation [1]\Loss per Material\Volume loss in Rogers RT-duroid 6010LM (lossy)
files=s:cVolume_loss_in_Rogers RT-duroid 6010LM (lossy)(1).sig
...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\Rogers RT-duroid 6010LM (lossy)\Dispersive\Eps' (Fit)
files=s:Rogers RT-duroid 6010LM (lossy)_eps_re.sig
...
result=s:0
treepath=s:1D Results\Materials\Rogers RT-duroid 6010LM (lossy)\Dispersive\Eps'' (Fit)
files=s:Rogers RT-duroid 6010LM (lossy)_eps_im.sig
...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\Rogers RT-duroid 6010LM (lossy)\Dispersive\Eps TangD (Fit)
files=s:Rogers RT-duroid 6010LM (lossy)_eps_tgd.sig
